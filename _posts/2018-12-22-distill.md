...
$$
Scaling Factor = \frac{Model size for Low bit training }{Model size for FP16 Baseline}
$$
**Example**: 1bit quantization model requires 1.8× the size of the original model to perform 90% → Scaling Factor = 1.8


### Results
Based on our survey of references <a href="https://arxiv.org/abs/2402.17764">[4]</a>–<a href="https://arxiv.org/abs/2402.11295">[8]</a>, we extracted the scaling factor required to approach FP16 performance. When the model size tested in the reference was less than 90% of the performance of the zero-shot accumulation, it was marked as Inconclusive (Red).
